...
class TextTest extends TestCase{
    ...
    public function testExcerptDefault()
    {
        ...
        $this->assertEquals(
            'Esse nostrud sunt id tempor amet eiusmod anim. Esse nostrud sunt id tempor amet eiusmod anim. Esse nostrud...', TextController::excerpt($text));
    }
    public function testExcerptDefaultEndWhiteSpace()
    {
        ...
        $this->assertEquals(
            'Esse nostrud sunt id tempor amet eiusmod anim. Esse nostrud sunt id tempor amet eiusmod anim. Essen...', TextController::excerpt($text));
    }
    public function testExcerpt50()
    {
        $text = "Esse nostrud sunt id tempor amet eiusmod anim. Esse nostrud sunt id tempor amet eiusmod anim. Esse nostrud sunt id tempor amet eiusmod anim.";
        $this->assertEquals(
            'Esse nostrud sunt id tempor amet eiusmod anim. Esse...', TextController::excerpt($text, 50));
    }
    public function testExcerptShortTextLimit50()
    {
        $text = "Esse nostrud sunt id tempor amet eiusmod";
        $this->assertEquals(
            'Esse nostrud sunt id tempor amet eiusmod', TextController::excerpt($text, 50));
    }
    public function testExcerptTextLimit50NoSpace()
    {
        ...
        $this->assertEquals(
            'EssenostrudsuntidtemporameteiusmodEssenostrudsunti...', TextController::excerpt($text, 50));
    }
